...
// Insert multiple arguments into middle of array
assertArraysEqual(splice(['a','b','c'], 2, 0, 'x','y','z'),  ['a','b','x','y','z','c']);

// Insert multiple arguments and replace
assertArraysEqual(splice(['a','b','c','d','e'], 2, 2, 'x','y','z'),  ['a','b','x','y','z','e']);
